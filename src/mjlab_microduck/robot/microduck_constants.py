...
def get_slalom_course_spec() -> mujoco.MjSpec:
    return mujoco.MjSpec.from_file(str(MICRODUCK_SLALOM_COURSE_XML))
...
MICRODUCK_SLALOM_COURSE_CFG = EntityCfg(
    spec_fn=get_slalom_course_spec,
)
